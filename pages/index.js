    ...
    <div className="bg-primary/60 h-full">
      ...
      <div className=" w-full h-full bg-gradient-to-r from-primary/10 via-black/30 to-black/10">
        <div className=" text-center flex flex-col justify-center xl:pt-40 xl:text-left h-full container mx-auto">
          ...
          >
            Hi, I am <br />
            <span className="text-accent font-bold  lg:text-7xl">
              Suman Singh
            </span>
          </motion.h1>
          {/* subtitle */}
      ...
      <div className="w-[1200px] h-full absolute right-0 bottom-0">
        {/* bg image */}
        <div className=" bg-none xl:bg-explosion xl:bg-cover xl:bg-right xl:bg-no-repeat w-full h-full absolute mix-blend-color-dodge opacity-60 animate-pulse duration-75 translate-z-0 "></div>
        {/* particles svg */}
        <ParticlesContainer />
        {/* avatar img */}
        <motion.div
